import WorkspaceMember from "../models/workspaceMebers.models.js"

class WorkspaceMemberRepository {

    // Buscamos una membresia en particular 
    ...
    async getByUserId(user_id){
        const memberships = await WorkspaceMember
            ...
            .populate(
                {
                    path: 'fk_workspace_id',//Propiedad expandir
        ...
        return memberships
        .filter(
            memberships => memberships.fk_workspace_id
        )
            .map(memberships => ({
                member_id: memberships._id,
                member_rol: memberships.rol,
                member_fecha_union: memberships.fecha_creacion,
                workspace_id: memberships.fk_workspace_id._id,
                workspace_nombre: memberships.fk_workspace_id.nombre,
                workspace_descripcion: memberships.fk_workspace_id.descripcion
            }));
    }
